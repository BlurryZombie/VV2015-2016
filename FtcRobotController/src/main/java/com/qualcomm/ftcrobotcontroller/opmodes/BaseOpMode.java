 ...
 */
@TeleOp(name="BaseOpMode",group="7797")
public class BaseOpMode extends LinearOpMode {
    ...
    public static final String CONFIG_FL_DRIVE =    "fl";
    public static final String CONFIG_FR_DRIVE =    "fr";
    public static final String CONFIG_BL_DRIVE =    "bl";
    public static final String CONFIG_BR_DRIVE =    "br";
    public static final String CONFIG_COLLECT =     "cl";
    public static final String CONFIG_CANNON =      "cn";
